...
<script type="text/javascript">
	var num = 0;
	var total = 0;
	/* order-scroller touch-scrollable
	order */
	       ...
	       $.ajax(
	          {
	             ...
	             success: function(data){
	                for(var i in data){
	                   info += '<article class="product" data-product-id="'
	...
	$(document).on('click', '.product', function(){
	    ...
	    $.ajax({
	       ...
	       success: function(data){
				...
				info += '<em>옵션 : </em>';
				info += ' 휘핑  샷추가  버블추가  시럽추가';
				
				info += ' <input type="hidden" name="cafe_product_code" value="'+data.cafe_product_code+'">';			
				info += ' <input type="hidden" name="cafe_product_name" value="'+data.cafe_product_name+'">';
				info += ' <input type="hidden" name="cafe_product_price" value="'+data.cafe_product_price+'">';
	...
	$(document).on('click', '.actionpad', function(){
		$("span .product-name").data("name", "Nextree");
		var y =  $('.order :input').serializeArray();
                                       ...
                                       <div class="subwindow-container-fix">
                                          <div class="order-container">
                                             <div class="order-scroller touch-scrollable">
                                                <div class="order">
<!--                                                  	<div class="summary clearfix"><div class="line"><div class="entry total">
